...
run: all
	@ ./${BIN_NAME} ./data/candidatos.csv ./data/partidos.csv 15/11/2020
...
valgrind: all
	@ clear
	@ valgrind ${VALGRIND_FLAGS} ./${BIN_NAME} ./data/candidatos.csv ./data/partidos.csv 15/11/2020
